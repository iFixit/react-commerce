...
import { BannersSectionSchema } from '@/models/concerns/sections/banners-section';
import { FAQsSectionSchema } from '@/models/concerns/sections/faqs-section';
import {
   lifetimeWarrantySectionFromStrapi,
   LifetimeWarrantySectionSchema,
} from '@/models/concerns/sections/lifetime-warranty-section';
import { PressQuotesSectionSchema } from '@/models/concerns/sections/press-quotes-section';
import { QuoteGallerySectionSchema } from '@/models/concerns/sections/quote-gallery-section';
import {
   relatedPostsSectionFromStrapi,
   RelatedPostsSectionSchema,
} from '@/models/concerns/sections/related-posts-section';
import { SplitWithImageSectionSchema } from '@/models/concerns/sections/split-with-image-section';
import { createSectionId } from '@/models/concerns/strapi-utils';
