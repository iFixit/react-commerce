...
(async () => {
   try {
      await spawn(
         `gq https://${shopName}.myshopify.com/api/2022-04/graphql.json --introspect -H 'X-Shopify-Storefront-Access-Token: ${apiKey}' -H 'Content-Type: application/json' > ${__dirname}/schema.graphql`
      );
   } catch (error) {
