...
export type Store = {
  ...
  header?: Maybe<ComponentStoreHeader>;
  id: Scalars['ID'];
  name: Scalars['String'];
  published_at?: Maybe<Scalars['DateTime']>;
...
export type StoreConnectionHeader = {
  __typename?: 'StoreConnectionHeader';
  connection?: Maybe<StoreConnection>;
  key?: Maybe<Scalars['ID']>;
};
...
export type StoreGroupBy = {
  ...
  header?: Maybe<Array<Maybe<StoreConnectionHeader>>>;
...
export type EditComponentStoreHeaderInput = {
  id?: Maybe<Scalars['ID']>;
  menu?: Maybe<Scalars['ID']>;
};
...
export type EditStoreInput = {
  ...
  header?: Maybe<EditComponentStoreHeaderInput>;
  name?: Maybe<Scalars['String']>;
  published_at?: Maybe<Scalars['DateTime']>;
...
export type MenuPropsFragment = { __typename?: 'Menu', items: Array<Maybe<{ __typename: 'ComponentMenuLink', name: string, url: string } | { __typename: 'ComponentMenuLinkWithImage', name: string, url: string, image?: Maybe<{ __typename?: 'UploadFile', alternativeText?: Maybe<string>, url: string, formats?: Maybe<any> }> } | { __typename: 'ComponentMenuProductListLink', name: string, productList?: Maybe<{ __typename?: 'ProductList', handle: string }> } | { __typename: 'ComponentMenuSubmenu', name: string, submenu?: Maybe<{ __typename?: 'Menu', items: Array<Maybe<{ __typename: 'ComponentMenuLink', name: string, url: string, description?: Maybe<string> } | { __typename: 'ComponentMenuLinkWithImage', name: string, url: string, image?: Maybe<{ __typename?: 'UploadFile', alternativeText?: Maybe<string>, url: string, formats?: Maybe<any> }> } | { __typename: 'ComponentMenuProductListLink', name: string, productList?: Maybe<{ __typename?: 'ProductList', handle: string }> } | { __typename: 'ComponentMenuSubmenu', name: string }>> }> }>> };
