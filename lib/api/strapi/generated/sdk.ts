...
export type CollectionGroupBy = {
   ...
   wiki_title_api_validated?: Maybe<
      Array<Maybe<CollectionConnectionWiki_Title_Api_Validated>>
   >;
...
export type Morph =
   ...
   | BottomContext
   | BottomContextConnection
   | BottomContextAggregator
   | BottomContextGroupBy
   | BottomContextConnectionId
   | BottomContextConnectionCreated_At
   | BottomContextConnectionUpdated_At
   | BottomContextConnectionSubheading
   | BottomContextConnectionDevice_Summary
   | BottomContextConnectionLocale
   | BottomContextConnectionPublished_At
   | CreateBottomContextPayload
   | UpdateBottomContextPayload
   | DeleteBottomContextPayload
   | Collection
   ...
   | CollectionConnectionHandle
   | CollectionConnectionTitle
   | CollectionConnectionDescription
   | CollectionConnectionImage
   | CollectionConnectionFilters
   | CollectionConnectionParent
   | CollectionConnectionWiki_Title_Api_Validated
   | CollectionConnectionLocale
   ...
   | DeviceGroupBy
   | DeviceConnectionId
   | DeviceConnectionCreated_At
   | DeviceConnectionUpdated_At
   | DeviceConnectionDevice
   | DeviceConnectionPart_Type
   | DeviceConnectionMeta_Description
   | DeviceConnectionSubheading
   | DeviceConnectionSummary
   | DeviceConnectionCanonical_Override
   | DeviceConnectionFaq_Section
   | DeviceConnectionDevice_Summary
   | DeviceConnectionLocale
   | DeviceConnectionPublished_At
   | CreateDevicePayload
   | UpdateDevicePayload
   | DeleteDevicePayload
   | FaqSection
   | FaqSectionConnection
   | FaqSectionAggregator
   | FaqSectionGroupBy
   | FaqSectionConnectionId
   | FaqSectionConnectionCreated_At
   | FaqSectionConnectionUpdated_At
   | FaqSectionConnectionHeading
   | FaqSectionConnectionFaq1
   | FaqSectionConnectionFaq2
   | FaqSectionConnectionFaq3
   | FaqSectionConnectionLocale
   | FaqSectionConnectionPublished_At
   | CreateFaqSectionPayload
   | UpdateFaqSectionPayload
   ...
   | FaqGroupBy
   | FaqConnectionId
   | FaqConnectionCreated_At
   | FaqConnectionUpdated_At
   | FaqConnectionQuestion
   | FaqConnectionAnswer
   | FaqConnectionLocale
   | FaqConnectionPublished_At
   | CreateFaqPayload
   | UpdateFaqPayload
   | DeleteFaqPayload
   | Menu
   ...
   | StoreSettingsGroupBy
   | StoreSettingsConnectionId
   | StoreSettingsConnectionCreated_At
   | StoreSettingsConnectionUpdated_At
   | StoreSettingsConnectionFooter
   | StoreSettingsConnectionSocialMediaAccounts
   | StoreSettingsConnectionStore
   | StoreSettingsConnectionLocale
   | StoreSettingsConnectionPublished_At
   ...
   | StoreGroupBy
   | StoreConnectionId
   | StoreConnectionCreated_At
   | StoreConnectionUpdated_At
   | StoreConnectionCode
   | StoreConnectionName
   | StoreConnectionUrl
...
export type StoreSettingsGroupBy = {
   ...
   socialMediaAccounts?: Maybe<
      Array<Maybe<StoreSettingsConnectionSocialMediaAccounts>>
   >;
...
export type MenuPropsFragment = {
   ...
   items: Array<
      Maybe<
         | { __typename: 'ComponentMenuLink'; name: string; url: string }
         | {
              __typename: 'ComponentMenuCollectionLink';
              name: string;
              linkedCollection?: Maybe<{
...
export function getSdk<C>(requester: Requester<C>) {
   return {
      getCollectionPageData(
         variables?: GetCollectionPageDataQueryVariables,
         options?: C
      ): Promise<GetCollectionPageDataQuery> {
         return requester<
            GetCollectionPageDataQuery,
            GetCollectionPageDataQueryVariables
         >(GetCollectionPageDataDocument, variables, options);
      },
   };
}
