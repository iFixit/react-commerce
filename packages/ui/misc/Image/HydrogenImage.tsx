 ...
 */
export const HydrogenImage = React.forwardRef(HydrogenImageInner);

export function HydrogenImageInner<GenericLoaderOpts>(
   ...
   if (props.data) {
      return <ShopifyImage ref={ref} {...props} />;
   } else {
      return <ExternalImage ref={ref} {...props} />;
   }
}
...
>;
type ShopifyImageProps = Omit<HtmlImageProps, 'src'> & {
...
const ShopifyImage = React.forwardRef<HTMLImageElement, ShopifyImageProps>(
   (
      {
         data,
         width,
...
const ExternalImage = React.forwardRef<
   HTMLImageElement,
