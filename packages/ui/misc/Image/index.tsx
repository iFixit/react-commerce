...
export function ImageInner<GenericLoaderOpts>(
   props: ImageProps<GenericLoaderOpts> & { injectable?: JSX.Element },
   ...
   return (
      <>
         {props.injectable}
         {props.data ? (
            <ShopifyImage ref={ref} {...props} />
         ) : (
            <ExternalImage ref={ref} {...props} />
         )}
      </>
   );
}
